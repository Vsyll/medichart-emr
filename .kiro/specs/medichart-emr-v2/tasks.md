...
- [x] 2. Definisikan data model dan inisialisasi localStorage
  ...
  - [ ]* 2.3 Tulis property test untuk round-trip serialization localStorage
...
- [x] 3. Implementasikan Auth_Module dan seed data demo
  ...
  - [ ]* 3.5 Tulis property test untuk Auth_Module
  ...
  - [ ]* 3.6 Tulis property test untuk penolakan akses Perawat
  ...
  - [ ]* 3.7 Tulis property test untuk logout
  ...
  - [ ]* 3.8 Tulis property test untuk akun nonaktif
...
- [~] 4. Checkpoint — Pastikan semua test Auth_Module lulus
  - Pastikan semua test lulus, tanyakan kepada user jika ada pertanyaan.

- [~] 5. Implementasikan halaman Login dan App Shell dengan RBAC
  - [~] 5.1 Perbarui halaman Login (`#page-login`)
  ...
  - [~] 5.2 Implementasikan App Shell dengan navigasi berbasis peran
  ...
  - [ ]* 5.3 Tulis unit test untuk halaman Login
...
- [-] 6. Implementasikan Admin_Module dan halaman Admin
  - [~] 6.1 Implementasikan `Admin_Module` (CRUD pengguna)
  ...
  - [~] 6.2 Implementasikan halaman Admin (`#page-admin`)
  ...
  - [ ]* 6.3 Tulis unit test untuk Admin_Module
...
- [~] 7. Implementasikan DiagReport_Module
  - [~] 7.1 Implementasikan fungsi inti DiagReport_Module
  ...
  - [ ]* 7.6 Tulis property test untuk transisi status `final` → `amended`
  ...
  - [~] 7.7 Implementasikan `DiagReport_Module.filterByType()` dan `validateReport()`
  ...
  - [ ]* 7.8 Tulis property test untuk konsistensi filter tipe
    - **Property 6: Konsistensi Filter Tipe** — `len(filter(lab)) + len(filter(imaging)) == len(all)` untuk semua pasien
    - **Validates: Requirements 20.4**

  - [ ]* 7.9 Tulis property test untuk konsistensi tampilan dan penyimpanan
...
- [~] 8. Checkpoint — Pastikan semua test DiagReport_Module lulus
  - Pastikan semua test lulus, tanyakan kepada user jika ada pertanyaan.

- [~] 9. Implementasikan UI Diagnostic Reports
  - [~] 9.1 Buat panel Diagnostic Reports (`#page-diag-reports`) dengan tab Lab/Imaging
  ...
  - [~] 9.2 Implementasikan form input hasil laboratorium
  ...
  - [~] 9.3 Implementasikan form input hasil radiologi/imaging
  ...
  - [~] 9.4 Implementasikan tampilan detail DiagnosticReport
  ...
  - [~] 9.5 Terapkan RBAC pada UI Diagnostic Reports
...
- [~] 10. Integrasi Diagnostic Reports dengan Encounter
  - [~] 10.1 Hubungkan DiagnosticReport dengan Encounter saat pembuatan
  ...
  - [~] 10.2 Tampilkan daftar DiagnosticReport terkait di detail Encounter
...
- [~] 11. Perbarui fitur yang sudah ada dengan RBAC
  - [~] 11.1 Terapkan RBAC pada form SOAP Notes
  ...
  - [ ]* 11.4 Tulis unit test untuk RBAC pada fitur yang sudah ada
...
- [~] 12. Checkpoint — Pastikan semua test integrasi lulus
  - Pastikan semua test lulus, tanyakan kepada user jika ada pertanyaan.

- [~] 13. Buat dokumentasi teknis — Diagram UML yang diperbarui
  - [~] 13.1 Perbarui `docs/use-case-diagram.puml`
  ...
  - [~] 13.2 Perbarui `docs/class-diagram.puml`
  ...
  - [~] 13.3 Perbarui `docs/sequence-diagram.puml`
...
- [~] 14. Buat dokumentasi teknis — Diagram baru
  - [~] 14.1 Buat `docs/component-diagram.puml`
  ...
  - [~] 14.2 Buat `docs/package-diagram.puml`
    - Kelompokkan komponen ke dalam paket logis: `Presentation`, `Business Logic`, `Data`, `Security`
    - Gambarkan dependensi antar paket dengan arah yang benar
    - _Requirements: 13.1, 13.2, 13.3_

  - [~] 14.3 Buat `docs/dfd-level0.puml`
  ...
  - [~] 14.4 Buat `docs/dfd-level1.puml`
...
- [~] 15. Buat dokumentasi teknis — Laporan dan README
  - [~] 15.1 Buat `docs/laporan.md`
...
- [~] 16. Verifikasi akhir dan polish
  - [~] 16.1 Verifikasi konsistensi visual dan responsivitas
  ...
  - [~] 16.2 Verifikasi konsistensi data lintas modul
  ...
  - [ ]* 16.3 Tulis unit test smoke test untuk integrasi keseluruhan
...
- [~] 17. Final Checkpoint — Pastikan semua test lulus
  - Pastikan semua test lulus, tanyakan kepada user jika ada pertanyaan.
